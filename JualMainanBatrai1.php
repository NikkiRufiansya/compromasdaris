...
<div class="container">
  ...
  <div class="row">
    ...
    <div class="col-lg-4 col-sm-6 mb-4">
      <div class="card h-90">
        <a href="#"><img class="card-img-top" src="image/main8.jpg" alt=""></a>
        <div class="card-body">
          <h4 class="card-title">
          <center>
          <a href="https://wa.me/6289686946758?text=" target="_blank">
  ...
  <ul class="pagination justify-content-center">
    <li class="page-item">
      <a class="page-link" href="JualMainanBatrai.php" aria-label="Previous">
    ...
    <li class="page-item">
      <a class="page-link" href="JualMainanBatrai2.php" aria-label="Next">
