...
<div class="container">
  <div class="card border-0 shadow my-5">
    <div class="card-body p-5">
      <b><h2 style="font-weight: bold; font-family: 'bookman'">Happy Family</h2></b>
      ...
      <div id="carouselExampleFade" class="carousel slide carousel-fade" data-ride="carousel">
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="image/happy1.jpeg" class="d-block w-100" alt="...">
          </div>
          <div class="carousel-item">
            <img src="image/happy2.jpeg" class="d-block w-100" alt="...">
          </div>
          <div class="carousel-item">
            <img src="image/happy3.jpeg" class="d-block w-100" alt="...">
          </div>
          <div class="carousel-item">
            <img src="image/happy4.jpeg" class="d-block w-100" alt="...">
          </div>
          <div class="carousel-item">
            <img src="image/happy5.jpeg" class="d-block w-100" alt="...">
          </div>
        </div>
