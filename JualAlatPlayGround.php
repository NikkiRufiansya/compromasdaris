...
<div class="container">
  ...
  <div class="row">
    <div class="col-lg-4 col-sm-6 mb-4">
      <div class="card h-90">
        <a href="#"><img class="card-img-top" src="image/product1.jpg" alt=""></a>
        <div class="card-body">
         <center>
    ...
    <div class="col-lg-4 col-sm-6 mb-4">
      <div class="card h-90">
        <a href="#"><img class="card-img-top" src="image/product2.jpg" alt=""></a>
        <div class="card-body">
          <center>
            <a href="https://wa.me/6289686946758?text=" target="_blank">
           <button type="button" class="btn btn-success"><i class="fa fa-whatsapp"></i> Pesan</button>  
    ...
    <div class="col-lg-4 col-sm-6 mb-4">
      <div class="card h-90">
        <a href="#"><img class="card-img-top" src="image/product3.jpg" alt=""></a>
        <div class="card-body">
         <center>
           <a href="https://wa.me/6289686946758?text=" target="_blank">
           <button type="button" class="btn btn-success"><i class="fa fa-whatsapp"></i> Pesan</button>  
    ...
    <div class="col-lg-4 col-sm-6 mb-4">
      <div class="card h-90">
        <a href="#"><img class="card-img-top" src="image/product4.jpg" alt=""></a>
        <div class="card-body">
          <h4 class="card-title">
          <center>
           <a href="https://wa.me/6289686946758?text=" target="_blank">
    ...
    <div class="col-lg-4 col-sm-6 mb-4">
      <div class="card h-90">
        <a href="#"><img class="card-img-top" src="image/product5.jpg" alt=""></a>
        <div class="card-body">
          <center>
            <a href="https://wa.me/6289686946758?text=" target="_blank">
           <button type="button" class="btn btn-success"><i class="fa fa-whatsapp"></i> Pesan</button>  
    ...
    <div class="col-lg-4 col-sm-6 mb-4">
      <div class="card h-90">
        <a href="#"><img class="card-img-top" src="image/product6.jpg" alt=""></a>
        <div class="card-body">
          <h4 class="card-title">
            <center>
            <a href="https://wa.me/6289686946758?text=" target="_blank">
  ...
  <ul class="pagination justify-content-center">
    ...
    <li class="page-item">
      <a class="page-link" href="JualAlatPlayGround1.php">2</a>
    </li>
    <li class="page-item">
      <a class="page-link" href="JualAlatPlayGround2.php">3</a>
    </li>
    <li class="page-item">
      <a class="page-link" href="JualAlatPlayGround1.php" aria-label="Next">
