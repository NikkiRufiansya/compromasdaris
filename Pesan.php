...
<div class="container">
  <div class="card border-0 shadow my-5">
    <div class="card-body p-5">
      <h2 class="font-weight-light">Pemesanan</h2>
      <p>Untuk Melakukan Pemesanan Silahkan Hubungi via : </p>
      <ul>
        <li><i class="fa fa-phone"> 0556 xxxx </i></li>
        <li><a href="https://wa.me/6285791104447?text=" target="_blank"><i class="fa fa-whatsapp"> Whatsapp</i></a></li>
      </ul>     
   ...
   <div class="container">
    ...
    <ul class="list-unstyled list-inline text-center">
      <li class="list-inline-item">
        <a class="btn-floating btn-fb mx-1" href="https://www.facebook.com/daris.funfactory">
      ...
      <li class="list-inline-item">
        <a class="btn-floating btn-instagram mx-1" href="https://www.instagram.com/funfactory.id/?hl=id">
