      ...
      <div class="container" style="font-family: bookman">
        <div class="row">
          ...
          <div class="col-sm-8">
            ...
            <p>Visi :<br>
              Mewujudkan sarana hiburan edukatif keluarga dan penggerak dalam membentuk masyarakat yang beriman,bertakwa serta bermanfaat bagi kehidupan sosial.
            </p>
            <p>Misi :</p>
            <ul>
              <li>Selalu berinovasi untuk menyempurnakan pelayanan & produk</li>
              <li>Meningkatkan kepercayaan konsumen akan produk & pelayanan</li>
              <li>Menguatkan sistem pemasaran dengan nilai-nilai kejujuran & ekonomis</li>
              <li>Menjaga kepercayaan dan nama baik kepada pihak dalam maupun luar perusahaan</li>
            </ul>
          </div>
        </div>
      </div>
