...
<div class="container">
  ...
  <div class="row">
    <div class="col-lg-4 col-sm-6 mb-4">
      <div class="card h-100">
        <a href="#"><img class="card-img-top" src="image/product13.jpg" alt=""></a>
        <div class="card-body">
          <h4 class="card-title">
            <center>
    ...
    <div class="col-lg-4 col-sm-6 mb-4">
      <div class="card h-100">
        <a href="#"><img class="card-img-top" src="image/product14.jpg" alt=""></a>
        <div class="card-body">
          <h4 class="card-title">
            <center>
          <a href="https://wa.me/6285791104447?text=" target="_blank">
  ...
  <ul class="pagination justify-content-center">
    <li class="page-item">
      <a class="page-link" href="JualAlatPlayGround1.php" aria-label="Previous">
