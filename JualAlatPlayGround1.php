...
<div class="container">
  ...
  <!-- Page Heading -->
  <h2 class="my-4">Jual Alat Playground indoor
  </h2>

  <div class="row">
    <div class="col-lg-4 col-sm-6 mb-4">
      <div class="card h-100">
        <a href="#"><img class="card-img-top" src="image/product7.jpg" alt=""></a>
        <div class="card-body">
          <center>
    ...
    <div class="col-lg-4 col-sm-6 mb-4">
      <div class="card h-90">
        <a href="#"><img class="card-img-top" src="image/product8.jpg" alt=""></a>
        <div class="card-body">
          <center>
          <a href="https://wa.me/6285791104447?text=" target="_blank">
           <button type="button" class="btn btn-success"><i class="fa fa-whatsapp"></i> Pesan</button>  
    ...
    <div class="col-lg-4 col-sm-6 mb-4">
      <div class="card h-100">
        <a href="#"><img class="card-img-top" src="image/product9.jpg" alt=""></a>
        <div class="card-body">
          <center>
          <a href="https://wa.me/6285791104447?text=" target="_blank">
           <button type="button" class="btn btn-success"><i class="fa fa-whatsapp"></i> Pesan</button>  
    ...
    <div class="col-lg-4 col-sm-6 mb-4">
      <div class="card h-100">
        <a href="#"><img class="card-img-top" src="image/product10.jpg" alt=""></a>
        <div class="card-body">
          <center>
          <a href="https://wa.me/6285791104447?text=" target="_blank">
           <button type="button" class="btn btn-success"><i class="fa fa-whatsapp"></i> Pesan</button>  
    ...
    <div class="col-lg-4 col-sm-6 mb-4">
      <div class="card h-100">
        <a href="#"><img class="card-img-top" src="image/product11.jpg" alt=""></a>
        <div class="card-body">
          <h4 class="card-title">
          <center>
          <a href="https://wa.me/6285791104447?text=" target="_blank">
    ...
    <div class="col-lg-4 col-sm-6 mb-4">
      <div class="card h-100">
        <a href="#"><img class="card-img-top" src="image/product12.jpg" alt=""></a>
        <div class="card-body">
          <center>
          <a href="https://wa.me/6285791104447?text=" target="_blank">
           <button type="button" class="btn btn-success"><i class="fa fa-whatsapp"></i> Pesan</button>  
  ...
  <ul class="pagination justify-content-center">
    <li class="page-item">
      <a class="page-link" href="JualAlatPlayGround.php" aria-label="Previous">
    ...
    <li class="page-item">
      <a class="page-link" href="JualAlatPlayGround2.php">3</a>
    </li>
    <li class="page-item">
      <a class="page-link" href="JualAlatPlayGround2.php" aria-label="Next">
