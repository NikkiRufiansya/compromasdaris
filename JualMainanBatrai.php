...
<div class="container">
  ...
  <!-- Page Heading -->
  <h2 class="my-4">Jual Mainan Batrai
  </h2>

  <div class="row">
    <div class="col-lg-4 col-sm-6 mb-4">
      <div class="card h-90">
        <a href="#"><img class="card-img-top" src="image/main1.jpg" alt=""></a>
        <div class="card-body">
         <center>
    ...
    <div class="col-lg-4 col-sm-6 mb-4">
      <div class="card h-90">
        <a href="#"><img class="card-img-top" src="image/main2.jpg" alt=""></a>
        <div class="card-body">
          <center>
          <a href="https://wa.me/6289686946758?text=" target="_blank">
           <button type="button" class="btn btn-success"><i class="fa fa-whatsapp"></i> Pesan</button>  
    ...
    <div class="col-lg-4 col-sm-6 mb-4">
      <div class="card h-90">
        <a href="#"><img class="card-img-top" src="image/main3.jpg" alt=""></a>
        <div class="card-body">
          <center>
         <a href="https://wa.me/6289686946758?text=" target="_blank">
           <button type="button" class="btn btn-success"><i class="fa fa-whatsapp"></i> Pesan</button>  
    ...
    <div class="col-lg-4 col-sm-6 mb-4">
      <div class="card h-90">
        <a href="#"><img class="card-img-top" src="image/main4.jpg" alt=""></a>
        <div class="card-body">
          <center>
            <a href="https://wa.me/6289686946758?text=" target="_blank">
           <button type="button" class="btn btn-success"><i class="fa fa-whatsapp"></i> Pesan</button>  
    ...
    <div class="col-lg-4 col-sm-6 mb-4">
      <div class="card h-90">
        <a href="#"><img class="card-img-top" src="image/main5.jpg" alt=""></a>
        <div class="card-body">
         <center>
           <a href="https://wa.me/6289686946758?text=" target="_blank">
           <button type="button" class="btn btn-success"><i class="fa fa-whatsapp"></i> Pesan</button>  
    ...
    <div class="col-lg-4 col-sm-6 mb-4">
      <div class="card h-90">
        <a href="#"><img class="card-img-top" src="image/main6.jpg" alt=""></a>
        <div class="card-body">
          <center>
           <a href="https://wa.me/6289686946758?text=" target="_blank">
           <button type="button" class="btn btn-success"><i class="fa fa-whatsapp"></i> Pesan</button>  
  ...
  <ul class="pagination justify-content-center">
    ...
    <li class="page-item">
      <a class="page-link" href="JualMainanBatrai1.php">2</a>
    </li>
    <li class="page-item">
      <a class="page-link" href="JualMainanBatrai2.php">3</a>
    </li>
    <li class="page-item">
      <a class="page-link" href="JualMainanBatrai1.php" aria-label="Next">
